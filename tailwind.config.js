  ...
  theme: {
  	extend: {
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px rgba(255, 122, 24, 0.4)',
  			'glow-lg': '0 0 40px -10px rgba(255, 122, 24, 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(255, 122, 24, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(255, 122, 24, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
  		...
  		backgroundImage: {
  			'gradient-rainbow': 'linear-gradient(135deg, #FF7A18 0%, #0FB4D4 100%)',
  			'gradient-primary': 'linear-gradient(135deg, #FF7A18, #0FB4D4)',
